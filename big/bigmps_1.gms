...
PARAMETERS
TC(I, J) trade cost of country ij,
...
$PROD:EX(I,J,G)
O:PFX(G) Q:100
I:PX(I,J,G) Q:(100*TC(I,J))

$PROD:IX(I,J,G)
O:PCX(I,J,G) Q:100
I:PFX(G) Q:(100*TC(I,J))
...
TC("9",J) = 1.0000025;
TC(I,J)$ (ORD(I) LT 9) = 1.45 - 0.05*ORD(I);
...
VOT(I,J) = SUM(G, PFX.L(G)* (EX.L(I,J,G)*TC(I,J) + IX.L(I,J,G)))/ (CONS.L(I,J)/100);
